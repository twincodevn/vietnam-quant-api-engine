        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-950 to-black p-8 font-sans text-slate-200">
            <div className="max-w-[1400px] mx-auto space-y-8">
                <div className="flex justify-between items-center py-4">
                    ...
                    <Link href="/" className="text-indigo-400 hover:text-indigo-300 font-medium flex items-center gap-2 hover:bg-slate-900 px-4 py-2 rounded-lg transition-colors border border-transparent hover:border-slate-800">
